...
<p className='text-center font-medium text-balance'>Let agents control your Chrome browser, all your websites already logged in. Automate real work</p>
...
<Bleed>
  <Frame caption='Your existing Chrome session. Extensions, logins, cookies — all there.'>
    <Image
